                              ...
                              <div class="card-body">
                                    <div class="form-row">
                                      ...
                                      <div class="form-group col-md-2">
                                        ...
                                        <select name="category_id" id="category_ids" class="form-control select2bs4" style="width: 100%;">
                                      ...
                                      <div class="form-group col-md-2">
                                        ...
                                        <select name="product_id" id="product_ids" class="form-control select2bs4" style="width: 100%;">
                                          <option value="">Select Product</option>
                                        </select>
                                      </div>
                                      <div class="form-group col-md-2">
                                        <label>Brand</label>
                                        <select name="brand_id" id="brand_ids" class="form-control select2bs4" style="width: 100%;">
                                      ...
                                      <div class="form-group col-md-1" style="padding-top: 35px;">
                                        <button type="button" class="btn btn-primary btn-sm addeventmore form-contorl" ><i class="fa fa-plus-circle"></i> Add</button>
                                      </div>
                                  </div>
                              </div>
                                <!-- /.card-body -->
...
<script id="document-template" type="text/x-handlebars-template">  
  <tr class="delete_add_more_item" id="delete_add_more_item">
    ...
    <td>
      <input type="hidden" name="category_ids[]" value="@{{category_id}}">@{{category_name}}
    </td>
    <td>
      <input type="hidden" name="product_ids[]" value="@{{product_id}}">@{{product_name}}
    </td> 
    <td>
      <input type="hidden" name="brand_ids[]" value="@{{brand_id}}">@{{brand_name}}
    </td>
    <td>
...
<script>
  $(document).ready(function(){
    $(document).on('click','.addeventmore', function(e){
      ...
      var brand_id = $('#brand_ids').val();
      var brand_name = $('#brand_ids').find('option:selected').text(); 
      var supplier_id = $('#supplier_id').val();
      var category_id = $('#category_ids').val();
      var category_name = $('#category_ids').find('option:selected').text(); 
      var product_id = $('#product_ids').val();
      var product_name = $('#product_ids').find('option:selected').text();
