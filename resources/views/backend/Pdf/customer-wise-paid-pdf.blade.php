        ...
        <table width="100%" >
          <tbody>
            <tr>
              ...
              <td width="40%" colspan="3" style="text-align: center;"><u><strong><span style="font-size:18px">Customer Wise Paid Report</strong></u></td>
           
            </tr>
           
            <tr>
              <td width="40%"><strong>Customer Name:</strong> {{$allData['0']['customer']['name']}}</td>
              <td width="25%"><strong>Mobile:</strong> {{$allData['0']['customer']['mobile_no']}}</td>
              <td width="35%"><strong>Address:</strong> {{$allData['0']['customer']['address']}}</td>
      ...
      <table width="100%" border="1">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align: center;">{{$total_paid}}/- Tk</td>
          </tr>
        </tbody>
      </table>
      @php
